...
// half3 SampleMetallicSpecGloss(float2 uv, half albedoAlpha)
// {
//     half3 specGloss;
//
//   #ifdef _METALLICSPECGLOSSMAP
//    half specGlossR = half4(SAMPLE_METALLICSPECULAR(uv)).r *_Metallic;
//     half specGlossG = half4(SAMPLE_METALLICSPECULAR(uv)).r *_Smoothness;
//     specGloss.r=specGlossR;
//     specGloss.g=specGlossG;
//     half occ = half4(SAMPLE_METALLICSPECULAR(uv)).b;
//     specGloss.b = LerpWhiteTo(occ, _OcclusionStrength);
...
//
//     half3 specGloss = SampleMetallicSpecGloss(uv, albedoAlpha.a);
//     outSurfaceData.albedo = albedoAlpha.rgb * _BaseColor.rgb;
//
// #if _SPECULAR_SETUP
//     outSurfaceData.metallic = half(1.0);
//     outSurfaceData.specular = -specGloss.g;
// #else
